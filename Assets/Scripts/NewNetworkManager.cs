...
public class NewNetworkManager : NetworkManager
{
    ...
    {
        base.Awake();
        Address = GameObject.Find("Address");
        if (Address != null)
            networkAddress = Address.GetComponent<PersistentAddress>().IPAddress;
        singleton = this;
    }
    ...
    public override void Start()
    {
        base.Start();
        Address = GameObject.Find("Address");
        if (Address == null || Address.GetComponent<PersistentAddress>().IsHost)
            StartHost();
        else
            StartClient();
    }
